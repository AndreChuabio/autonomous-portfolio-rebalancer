...
class TestPosition:
    ...
    def test_position_underweight(self):
        ...
        position = Position(
            ticker="NVDA", target_weight=0.08, current_weight=0.06, drift=-0.02
        )
    ...
    def test_position_drift_magnitude(self):
        ...
        position = Position(
            ticker="AAPL", target_weight=0.10, current_weight=0.13, drift=0.03
        )
...
class TestRiskMetrics:
    ...
    def test_risk_level_classification(self):
        ...
        high_risk = RiskMetrics(
            var_95=-5.0, sharpe_ratio=0.5, beta=1.8, volatility=0.30
        )
...
class TestTrade:
    ...
    def test_trade_buy(self):
        ...
        trade = Trade(
            ticker="NVDA", action="BUY", shares=100, value=20000.0, priority="MEDIUM"
        )
