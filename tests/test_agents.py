...
class TestMonitorAgent:
    ...
    def test_monitor_low_drift(self, mock_mcp_client, sample_portfolio):
        ...
        with patch.object(agent, '_fetch_portfolio_state', return_value=(sample_portfolio, RiskMetrics(
            var_95=-1.5, sharpe_ratio=2.0, beta=1.2, volatility=0.15
        ))):
...
class TestAnalyzerAgent:
    ...
    def test_generate_scenarios(self, mock_mcp_client, sample_portfolio, sample_risk_metrics):
    ...
    def test_score_scenarios(self, mock_mcp_client, sample_portfolio, sample_risk_metrics):
    ...
    def test_recommend_scenario(self, mock_mcp_client, sample_portfolio, sample_risk_metrics):
...
class TestDecisionAgent:
    ...
    def test_make_decision_execute(self, mock_mcp_client, sample_scenario, sample_portfolio, sample_risk_metrics):
        ...
        assert decision.decision_status in [DecisionStatus.EXECUTE, DecisionStatus.DEFER]
    ...
    def test_execution_timing(self, mock_mcp_client, sample_scenario, sample_risk_metrics):
